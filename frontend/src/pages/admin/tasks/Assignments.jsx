...
function ViewSubmissionModal({ assignment, onClose, onApprove, allSubmitted, currentIndex, onNext, onPrev }) {
  ...
  console.log('📄 ViewSubmissionModal opened for:', {
    title: assignment.title,
    hasFile: !!assignment.submittedFile,
    fileName: assignment.submittedFile,
    fileUrl: assignment.submittedFile ? `/uploads/${assignment.submittedFile}` : 'N/A'
  });
            ...
            <div>
              ...
              <div className="flex gap-2">
                <a href={`/uploads/${assignment.submittedFile}`} target="_blank" rel="noreferrer"
                  ...
                  <FileText size={14} /> View File ({assignment.submittedFile.slice(-4)})
                </a>
                <a href={`/uploads/${assignment.submittedFile}`} download={assignment.submittedFile}
              ...
              <p className="text-xs text-slate-500 mt-2">File: {assignment.submittedFile}</p>
            </div>
          )}
